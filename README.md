...
[![Version](https://img.shields.io/badge/version-0.3.15-1f7a8c.svg)](https://github.com/PanJitao/word-to-markdown/releases/latest)
...
当前源码版本为 `0.3.15`。文档转换、预览和外观设置均在本机运行，文件不会上传到服务端。
...
```text
src-tauri/target/release/bundle/nsis/MarkFlow_0.3.15_x64-setup.exe
```
